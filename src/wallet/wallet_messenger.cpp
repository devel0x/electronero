                               ...
                               const std::string &subject, const std::string &body)
{
  ...
  oss << to_addr << '\t' << from_addr << '\t' << subject << '\t' << body;
  return oss.str();
}
                         ...
                         std::string &subject, std::string &body)
{
  ...
  if(!std::getline(iss, to_addr, '\t')) return false;
  if(!std::getline(iss, from_addr, '\t')) return false;
  if(!std::getline(iss, subject, '\t')) return false;
