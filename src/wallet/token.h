...
struct TokenLedgerState {
    ...
    {
        READWRITE(obj.balances, obj.allowances, obj.totalSupply, obj.token_meta, obj.history, obj.governance_fees, obj.fee_per_vbyte, obj.create_fee_per_vbyte, obj.wallet_signers, obj.version);
    }
};
