  ...
  window.require(['vs/editor/editor.main'], () => {
    monaco.editor.defineTheme('gex-gel', {
      ...
      rules: [
        ...
        { token: 'comment', foreground: '5B6EA6' },
      ...
      colors: {
        ...
        'editor.selectionBackground': '#2B4E8A66',
        'editor.inactiveSelectionBackground': '#1E345866',
        'editor.lineHighlightBackground': '#14213A88',
        'editorIndentGuide.background1': '#1F3D6A55',
        'editorIndentGuide.activeBackground1': '#5AA7FFAA',
        'editorBracketMatch.background': '#1F74D433',
        'editorBracketMatch.border': '#62CCFF99',
      },
    });
