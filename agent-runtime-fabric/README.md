...
## 13) Reference MVP Implementation (This Repo)

A runnable MVP scaffold is included at:

- `agent-runtime-fabric/runtime_fabric_mvp/`

It provides a tool-mediated control-plane API and a low-trust worker that executes Python and Node.js jobs in session-scoped workspaces under a disposable runtime root.
