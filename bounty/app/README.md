...
A bot token is required for each platform so the server can confirm users have joined your community channels. See [docs/bots.md](docs/bots.md) for example code and setup steps.
