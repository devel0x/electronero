...
* **Languages** – set `DEFAULT_LANGUAGE` to control which translation is shown by default. Users may specify `/?lang=es` or another code to view the interface in that language.
